...
- Name: demo\vwo_login.spec.ts >> VWO Login Page Tests >> TC-05: Login with Script/SQL Injection strings
- Location: demo\vwo_login.spec.ts:38:9
...
Locator: getByText('Your email, password, IP address or location did not match')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Your email, password, IP address or location did not match')
